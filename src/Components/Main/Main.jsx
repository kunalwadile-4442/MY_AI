      ...
      <div className="lg:w-screen sm:w-screen  flex flex-col items-center  overflow-y-scroll scroll-smooth"> 
        <div className="h-screen bg-white  flex flex-col justify-between">
          ...
          <div
            ...
            <h1 className="text-xl ms-2">Wizard Ai</h1>
          ...
          {prompt ? (
            ...
            <div className="middle-part w-12/12 sm:gap-10  flex flex-col items-center p-3">
              ...
              <div className="cards w-12/12 h-72 z-12 flex justify-center gap-1 items-end sm:flex-wrap">
                <motion.div className="card1 w-48 h-40 rounded-lg border p-2 relative bg-slate-300 hover:bg-slate-500 "
                animate={{x:[-2000,0]}}
                transition={{duration:1}}
                >
                ...
                <motion.div className="card2 w-48 h-40 rounded-lg border p-2 relative bg-slate-300 hover:bg-slate-500"
                animate={{x:[-2000,0]}}
                transition={{duration:1}}
                >
                  <p className="text-wrap cursor-pointer"
                ...
                <motion.div className="card3 w-48 h-40 rounded-lg border p-2 relative bg-slate-300 hover:bg-slate-500"
                 animate={{x:[-2000,0]}}
                 transition={{duration:1}}
                >
                  <p className="text-wrap cursor-pointer"
                ...
                <motion.div className="card4 w-48 h-40 rounded-lg border p-2 relative bg-slate-300 hover:bg-slate-500"
                 animate={{x:[-2000,0]}}
                 transition={{duration:1}}
                >
                  <p className="text-wrap cursor-pointer"
